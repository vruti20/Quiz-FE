  ...
  return (
    <>
      <div className="bg-[#0F172A]">
        <Row className="flex ">
          <Col className="md:w-[410px] lg:w-[530px]  py-2 px-2">
            ...
            <div class=" text-white font-bold text-18">
              Join QuizTwiz now!👋
            </div>
              <div class=" text-[12px] text-[#8789c3]">
                Play Quizzes and Win Coins
              </div>
            </div>

            <div className=" text-center">
              <input class="bg-[#0F172A] border-[3px] border-white border-solid rounded-full py-[10px] text-center px-8" placeholder="Enter phone number" type="tel" />
            </div>
            <div className="text-center pt-5">
              <Button className="bg-[#1A2F77] text-white font-bold text-[16px] border-[3px] border-white border-solid rounded-full py-[10px] text-center px-[85px]">GET CODE</Button>
            </div>
            ...
            <div className="text-center w-full flex justify-center">
              ...
              <div className="  bg-white flex py-[8px] mt-3 px-3 rounded-[5px]">
                ...
                <span class="font-[400] text-[14px] align-middle pl-2 ">
                  Sign in with Google
                </span>
              </div>
            </div>
