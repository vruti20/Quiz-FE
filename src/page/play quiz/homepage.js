...
const Home = () => {  
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get(
          "https://222f-223-179-148-39.ngrok-free.app/api/category/allcategories" ,
          {headers: {
    ...
    const fetchCategory = async () => {
      try {
        const response = await axios.get(
          "https://222f-223-179-148-39.ngrok-free.app/api/category/allsubcategories" , 
          {headers: {
            'ngrok-skip-browser-warning': 5000
          }}    
        );
    ...
    const fetchSubCategory = async () => {
      try {
        if (selectedCategory) {
          const response = await axios.get(
            `https://222f-223-179-148-39.ngrok-free.app/api/category/subcategories/${selectedCategory}`,
            {headers: {
              'ngrok-skip-browser-warning': 5000
            }}
          );
